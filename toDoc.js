    ...
    function toDoc() {
        ...
        doc.createImage = function(sectionType, imageURL, position, align, imageWidth, imageHeight) {
            ...
            if (imageURL.indexOf("data") == 0) {
                var imgHTML = "<div align='" + imageObj.imgAlign + "'><img width='" + imageObj.imgWidth + "' height='" + imageObj.imgHeight + "' src='" + imageURL + "' crossOrigin='anonymous'></img></div>";
        ...
        var getImage = function(url, imgAlign, imgWidth, imgHeight, callBack) {
            ...
            request.onload = request.onerror = function() {
                ...
                var imgHTML = "<div align='" + imgAlign + "'><img width='" + imgWidth + "' height='" + imgHeight + "' src='" + src + "' crossOrigin='anonymous'></img></div>"
